...
public class WechatTools {
    ...
    public static boolean sendMsgById(String msg, String toUserName) {
        return MessageTools.sendMsgByUserName(msg, toUserName);
    }
    ...
    public static List<JSONObject> searchUserNameByNickName(String nickName) {
        List<JSONObject> contactNickNameList = new ArrayList<JSONObject>();
        for (JSONObject o : core.getContactList()) {
            if (o.getString("NickName").contains(nickName)) {
                contactNickNameList.add(o);
            }
        }
    ...
    public Map<String, String> getGroupNameMap() {
        return Core.getInstance().getGroupIdNameMap();
    }
}
