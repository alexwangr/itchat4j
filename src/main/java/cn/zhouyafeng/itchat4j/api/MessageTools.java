...
public class MessageTools {
    ...
    public static boolean sendMsgByUserName(String text, String toUserName) {
        if (text == null) {
            return false;
        }
        LOG.info(String.format("发送消息 %s: %s", toUserName, text));
        return wxSendMsg(text, toUserName);
    }
     ...
     * @date 2017年4月23日 下午2:32:02
     */
    private static boolean wxSendMsg(String content, String toUserName) {
        String url = String.format(URLEnum.WEB_WX_SEND_MSG.getUrl(), core.getLoginInfo().get("url"));
        Map<String, Object> msgMap = new HashMap<String, Object>();
        msgMap.put("Type", 1);
        msgMap.put("Content", content);
    ...
    public static boolean sendPicMsgByUserId(String userId, String filePath) {
        ...
        LOG.info("webWxUploadMedia result:" + responseObj);
        if (responseObj != null) {
    ...
    public static String uploadMedia(String filePath) {
        JSONObject responseObj = webWxUploadMedia(filePath);
        LOG.info("uploadMedia result:" + responseObj);
        if (responseObj != null) {
            return responseObj.getString("MediaId");
        }
        return null;
    }

    public static boolean sendPicByUserId(String userId, String mediaId) {
        return webWxSendMsgImg(userId, mediaId);
    }
    ...
    private static boolean webWxSendMsgImg(String userId, String mediaId) {
        ...
        if (entity != null) {
            try {
                ...
                LOG.error("webWxSendMsgImg 111错误： ", e);
            }
        }
        return false;
